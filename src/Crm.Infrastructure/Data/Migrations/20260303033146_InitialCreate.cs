        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExternalContactId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BusinessAssignments", x => new { x.BusinessId, x.UserId });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BusinessStatusId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ContactAssignments", x => new { x.ContactId, x.UserId });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserPermissionOverrideId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    PermissionId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserPermissionOverrides", x => x.UserPermissionOverrideId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BusinessAssignments_TenantId",
                table: "BusinessAssignments",
                column: "TenantId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BusinessContacts_TenantId",
                table: "BusinessContacts",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_Businesses_TenantId_Name",
                table: "Businesses",
                columns: new[] { "TenantId", "Name" });

            migrationBuilder.CreateIndex(
                name: "IX_ContactAssignments_TenantId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Statuses_TenantId_StatusTypeId_Key",
                table: "Statuses",
                columns: new[] { "TenantId", "StatusTypeId", "Key" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_StatusTypes_TenantId_Key",
                table: "StatusTypes",
                columns: new[] { "TenantId", "Key" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserPermissionOverrides_TenantId_UserId_PermissionId",
                table: "UserPermissionOverrides",
